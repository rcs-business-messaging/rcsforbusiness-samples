...
public class RCSBusinessMessaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Phones {
    ...
    /**
     * An accessor for creating requests from the AgentMessagesSigned collection.
     *
     * <p>The typical use is:</p>
     * <pre>
     *   {@code RCSBusinessMessaging rcsbusinessmessaging = new RCSBusinessMessaging(...);}
     *   {@code RCSBusinessMessaging.AgentMessagesSigned.List request = rcsbusinessmessaging.agentMessagesSigned().list(parameters ...)}
     * </pre>
     *
     * @return the resource collection
     */
    public AgentMessagesSigned agentMessagesSigned() {
      return new AgentMessagesSigned();
    }

    /**
     * The "agentMessagesSigned" collection of methods.
     */
    public class AgentMessagesSigned {

      /**
       * Sends a message from the agent to a user.
       *
       * Create a request for the method "agentMessagesSigned.create".
       *
       * This request holds the parameters needed by the rcsbusinessmessaging server.  After setting any
       * optional parameters, call the {@link Create#execute()} method to invoke the remote operation.
       *
       * @param parent Required. "phones/{E.164}", where {E.164} is the user's phone number in E.164 format. For example,
       *        with the US phone number +1-222-333-4444, the value would be phones/+12223334444, and the
       *        resulting endpoint would be
       *        https://rcsbusinessmessaging.googleapis.com/v1/phones/+12223334444/agentMessages.
       * @return the request
      ...
      public class Create extends RCSBusinessMessagingRequest<com.google.api.services.rcsbusinessmessaging.v1.model.AgentMessage> {
        ...
        private static final String REST_PATH = "v1/{+parent}/agentMessagesSigned";
       ...
       *        https://rcsbusinessmessaging.googleapis.com/v1/phones/+12223334444/agentMessages.
        ...
        protected Create(java.lang.String parent) {
          super(RCSBusinessMessaging.this, "POST", REST_PATH, null, com.google.api.services.rcsbusinessmessaging.v1.model.AgentMessage.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
        ...
        /**
         * Required. "phones/{E.164}", where {E.164} is the user's phone number in E.164 format. For
         * example, with the US phone number +1-222-333-4444, the value would be
         * phones/+12223334444, and the resulting endpoint would be
         * https://rcsbusinessmessaging.googleapis.com/v1/phones/+12223334444/agentMessages.
         */
        @com.google.api.client.util.Key
        ...
        /** Required. "phones/{E.164}", where {E.164} is the user's phone number in E.164 format. For example,
       with the US phone number +1-222-333-4444, the value would be phones/+12223334444, and the resulting
       endpoint would be https://rcsbusinessmessaging.googleapis.com/v1/phones/+12223334444/agentMessages.
         */
        public java.lang.String getParent() {
          return parent;
        }
       ...
       that was used by an earlier message or event sent from the same agent.
        ...
        @com.google.api.client.util.Key("httpBody.contentType")
        private java.lang.String httpBodyContentType;

        /** The HTTP Content-Type header value specifying the content type of the body.
         */
        public java.lang.String getHttpBodyContentType() {
          return httpBodyContentType;
        }

        /** The HTTP Content-Type header value specifying the content type of the body. */
        @com.google.errorprone.annotations.CanIgnoreReturnValue
        public Create setHttpBodyContentType(java.lang.String httpBodyContentType) {
          this.httpBodyContentType = httpBodyContentType;
          return this;
        }

        /** The HTTP request/response body as raw binary. */
        @com.google.api.client.util.Key("httpBody.data")
        private java.lang.String httpBodyData;

        /** The HTTP request/response body as raw binary.
         */
        public java.lang.String getHttpBodyData() {
          return httpBodyData;
        }

        /** The HTTP request/response body as raw binary. */
        @com.google.errorprone.annotations.CanIgnoreReturnValue
        public Create setHttpBodyData(java.lang.String httpBodyData) {
          this.httpBodyData = httpBodyData;
          return this;
        }
         ...
         * APIs.
         */
        @com.google.api.client.util.Key("httpBody.extensions")
        private java.util.List<java.lang.Object> httpBodyExtensions;

        /** Application specific response metadata. Must be set in the first response for streaming APIs.
         */
        public java.util.List<java.lang.Object> getHttpBodyExtensions() {
          return httpBodyExtensions;
        }
         ...
         */
        @com.google.errorprone.annotations.CanIgnoreReturnValue
        public Create setHttpBodyExtensions(java.util.List<java.lang.Object> httpBodyExtensions) {
          this.httpBodyExtensions = httpBodyExtensions;
          return this;
        }
